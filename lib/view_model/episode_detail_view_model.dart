...
class EpisodeDetailViewModel with ChangeNotifier{
  ...
  List<String> _seasonList = [
    ...
    "62,63,64,65,66,67,68,69,70,71", //7.sezon
    "72,73,74,75,76,77,78,79,80,81"]; //8.sezon


  List<Episode> _allEpisode =[];

  List<Episode> get allEpisode => _allEpisode;

  set allEpisode(List<Episode> value) {
    _allEpisode = value;
  }
  ...
  void getSeason() async{
    ...
    switch(selectedSeason){
      case 0:
        selectedList = _allEpisode;
        break;

      case 1:
        selectedList = await getApiList(_seasonList[0]);
        break;

      case 2:
        selectedList = await getApiList(_seasonList[1]);
        break;

      case 3:
        selectedList = await getApiList(_seasonList[2]);
        break;

      case 4:
        selectedList = await getApiList(_seasonList[3]);
        break;

      case 5:
        selectedList = await getApiList(_seasonList[4]);
        break;

      case 6:
        selectedList = await getApiList(_seasonList[5]);
        break;
      ...
      case 8:
        selectedList = await getApiList(_seasonList[7]);
        break;
  ...
  void allCharacterInternet() async{
